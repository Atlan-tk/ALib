...
#define AStack_Generate(T)                                                          \
    ...
    static inline void __Ascf(T,iter_prev)(AIter(AStack(T))* it){                   \
        it->i--; it->p = __Ascf(T,at)(it->con, it->i);                              \
                                                                                    ...
                                                                                    \
    __weak __visibility(protected) void A_OBJ_DEST(AStack(T))                       \
    (AStack(T)* self){                                                              \
    ...
    __weak __visibility(protected) void A_OBJ_INIT(AStack(T))                       \
    (AStack(T)* self){                                                              \
        __Adeq_init(&self->deq, sizeof(T));                                         \
        self->f = &A_FUNC_TAB(AStack(T));                                           \
    }                                                                               \
    __weak __visibility(protected) void A_OBJ_COPY(AStack(T))                       \
    ...
    __weak __visibility(protected) int A_OBJ_CMPD(AStack(T))                        \
